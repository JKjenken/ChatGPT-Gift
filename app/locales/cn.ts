  ...
  Error: {
    Unauthorized: isApp
      ...
      : `点击[这里](/#/auth)输入访问秘钥 🔑
       ...
       \ 左下角设置可配置默认模型，deepseek-R1的模型名称为 deepseek-reasoner 
       \ 对话设置选项影响输出结果！强烈建议按需配置！
       \ 随机性设置 影响输出结果，deepseek 分为五个等级：代码生成/数学解题 0.0 ； 数据抽取/分析 1.0 ；通用对话 1.3 ；翻译 1.3 ；创意类写作/诗歌创作 1.5 ；其余模型类似。
       `,
  },
  Auth: {
    Return: "返回",
